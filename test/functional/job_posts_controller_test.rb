...
class JobPostsControllerTest < ActionController::TestCase
  ...
  test "should create job_post" do
    assert_difference('JobPost.count') do
      post :create, job_post: { company: @job_post.company, description: @job_post.description, instructions: @job_post.instructions, location: @job_post.location, title: @job_post.title }
    end
  ...
  test "should update job_post" do
    put :update, id: @job_post, job_post: { company: @job_post.company, description: @job_post.description, instructions: @job_post.instructions, location: @job_post.location, title: @job_post.title }
    assert_redirected_to job_post_path(assigns(:job_post))
  end
